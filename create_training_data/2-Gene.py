...
# Attach meta data
FINALTABLE = pd.concat([TABLEmeta, TABLEdf], axis=1)


OutpuFilePickle = '/lustre/scratch/tv349/AMR/GeneTrainingData/'+Species+\
'/GENETRAININGDATA.'+MetaFileName+'-Part'+str(Thread)+'.p'
...
OutpuFilePickle = '/lustre/scratch/tv349/AMR/GeneTrainingData/'+Species+\
'/GENETRAININGDATA.'+MetaFileName+'-Part'+str(Thread)+'.tsv'
print('Saving data to file '+OutpuFilePickle)
